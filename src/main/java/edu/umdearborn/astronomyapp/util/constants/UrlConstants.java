...
public final class UrlConstants {
  ...
  public static final String[] PUBLIC_PATH_PATTERNS =
      {"/", "/login", "/index.html", "/app.js", "/app.css", "/app**.js", "/views/**", "/models/**",
          "/assets/**", "/components/**", "/dist/**", "/logout", "/rest/session-*"};
  ...
  public static final String SESSION_EXPIRED_PATH = REST_PATH_PREFIX + "/session-expired";
  public static final String SESSION_INVALID_PATH = REST_PATH_PREFIX + "/session-invalid";
